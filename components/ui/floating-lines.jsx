...
const vec3 PINK  = vec3(163.0, 240.0, 239.0) / 255.0;
const vec3 BLUE  = vec3(51.0, 70.0, 215.0) / 255.0;
...
export default function FloatingLines({
  ...
  return (
    <div
      ref={containerRef}
      className={`floating-lines-container relative h-full w-full overflow-hidden ${className}`}
      style={{ mixBlendMode }}
    />
  );
}
