...
export default function AdminToast({ message }) {
  ...
  const clearNotice = useCallback(() => {
    ...
    nextParams.delete("deleted_item");
    nextParams.delete("created_item");
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-50 flex justify-center px-3">
      <div
        role="status"
        aria-live="polite"
        className="pointer-events-auto w-[min(92vw,28rem)] animate-rise rounded-b-xl border border-t-0 border-success/45 bg-[linear-gradient(150deg,rgba(14,37,52,0.98),rgba(12,28,45,0.98))] px-4 py-3 text-sm text-ink shadow-[0_20px_48px_-26px_rgba(11,35,52,0.95)]"
      >
